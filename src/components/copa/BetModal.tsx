              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="bg-card p-5 rounded-[32px] border border-white/5 space-y-4 shadow-lg">
                  ...
                  <div className="bg-white p-6 rounded-3xl flex flex-col items-center gap-3">
                    <img src="/pix-60.png" alt="PIX 60" style={{ width: '224px', height: '224px', display: 'block', margin: '0 auto', backgroundColor: 'white', padding: '8px', borderRadius: '12px' }} />
                ...
                <div className="bg-card p-5 rounded-[32px] border-2 border-primary/20 space-y-4 relative overflow-hidden group shadow-lg">
                  ...
                  <div className="bg-white p-6 rounded-3xl flex flex-col items-center gap-3">
                    <img src="/pix-100.png" alt="PIX 100" style={{ width: '224px', height: '224px', display: 'block', margin: '0 auto', backgroundColor: 'white', padding: '8px', borderRadius: '12px' }} />
